...
export function buildGenerationContinuationGroup(args: {
  ...
  return {
    ...
    generationEnqueuedAt: generation.generationEnqueuedAt,
    coordinatorStartedAt: generation.coordinatorStartedAt,
    participantStartedAt: generation.participantStartedAt,
    workflowStartAsync: generation.workflowStartAsync,
